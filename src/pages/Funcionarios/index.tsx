    ...
    <Layout>
      <div className="p-xl max-w-[1200px] mx-auto w-full">
          ...
          <header className="flex items-center justify-between mb-xl">
            ...
            <button onClick={() => setIsModalOpen(true)} className="flex items-center gap-sm bg-primary text-on-primary px-lg py-sm rounded-DEFAULT hover:shadow-[0_4px_12px_rgba(0,0,0,0.1)] transition-all font-label-md text-label-md active:scale-[0.98]">
          ...
          <div className="bg-surface-container-lowest rounded-xl border border-outline-variant shadow-[0_4px_12px_rgba(0,0,0,0.02)] overflow-hidden">
                    ...
                    <tr key={func.id} className="hover:bg-surface-container-low transition-colors group">
                      <td className="py-md px-lg">
                        <div className="flex items-center gap-md">
                          <div className={`w-10 h-10 rounded-full ${func.iniciaisVariant} flex items-center justify-center font-label-md text-label-md`}>{func.iniciais}</div>
                          <div><p className="font-label-md text-label-md text-on-surface">{func.nome}</p><p className="font-body-sm text-body-sm text-on-surface-variant">@{func.usuario}</p></div>
                        </div>
                      </td>
            ...
            <div className="p-md border-t border-outline-variant bg-surface-container-lowest flex items-center justify-between">
              <span className="font-body-sm text-body-sm text-on-surface-variant">Mostrando 1 a {funcionarios.length} de 124 funcionários</span>
